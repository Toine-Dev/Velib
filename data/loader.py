...
# @st.cache_data
# def load_raw_data(velib_path=VELIB_PATH, weather_path=WEATHER_PATH):
...
#     df_merged = pd.merge(df_velib, df_weather, how="left", left_on="date_et_heure_de_comptage", right_on="time").drop(columns=["time"])
#     return df_merged
